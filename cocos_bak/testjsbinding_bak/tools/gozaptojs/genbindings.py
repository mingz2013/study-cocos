...
def main():
    ...
    gozap_root = os.path.abspath(os.path.join(project_root, 'frameworks/gozap'))
    ...
    try:
        ...
        output_dir = '%s/frameworks/gozap/js-bindings/bindings/auto' % project_root

        cmd_args = {'gozap.ini':('gozap', 'jsb_gozap_auto')}
        target = 'spidermonkey'
