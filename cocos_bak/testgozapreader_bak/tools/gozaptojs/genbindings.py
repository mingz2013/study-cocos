...
################################
    ...
    gozap_root = os.path.abspath(os.path.join(project_root, 'frameworks/js-bindings/gozap'))
...
#####################
    ...
    config.set('DEFAULT', 'gozapdir', gozap_root)
...
##########################################
        ...
        gozaptojs_root = '%s/tools/gozaptojs' % project_root

        output_dir = '%s/frameworks/js-bindings/gozap/bindings/auto' % project_root

        cmd_args = {\
            'gozap.ini':('gozap', 'jsb_gozap_auto'),\
        }
